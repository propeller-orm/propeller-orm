...
class ClassTools
{
     ...
     * If not, will return 'BasePeer'
     *
     * @return class-string
     */
    public static function getBasePeer(Table $table)
    {
        return $table->getBasePeer() ?: BasePeer::class;
    }
    ...
    {
        return $table->getBaseClass() ?: BaseObject::class;
    }
    ...
    {
        return [
            'and', 'or', 'xor', 'exception', '__FILE__', '__LINE__', 'array', 'as', 'break', 'case', 'class', 'const',
            ...
            'global', 'if', 'include', 'include_once', 'isset', 'list', 'new', 'print', 'require', 'require_once',
            'return', 'static', 'switch', 'unset', 'use', 'var', 'while', '__FUNCTION__', '__CLASS__', '__METHOD__',
            'final', 'php_user_filter', 'interface', 'implements', 'extends', 'public', 'protected', 'private',
            'abstract', 'clone', 'try', 'catch', 'throw', 'this', 'namespace', 'yield',
        ];
    }
}
