...
interface NodePeer
{
     ...
     *
     * @param NodeObject     $child  Propel object for child node
     * @param NodeObject     $parent Propel object for parent node
     * @param PropelPDO|null $con    Connection to use.
     *
     * @return void
     */
     ...
     *
     * @param NodeObject     $node    Propel object for destination node
     * @param NodeObject     $sibling Propel object for source node
     * @param PropelPDO|null $con     Connection to use.
     *
     * @return void
     */
     ...
     *
     * @param NodeObject     $parent Propel object for given parent node
     ...
     *
     * @param NodeObject     $node Propel object as root node
     * @param PropelPDO|null $con  Connection to use.
     *
     * @return void
     */
     ...
     * Delete $dest node
     *
     * @param NodeObject     $dest Propel object node to delete
     * @param PropelPDO|null $con  Connection to use.
     *
     * @return boolean Deletion status
     */
     ...
     *
     * @param NodeObject     $dest Propel object for destination node
     * @param NodeObject     $node Propel object for source node
     * @param PropelPDO|null $con  Connection to use.
     *
     * @return void
     */
     ...
     *
     * @param NodeObject     $node Propel object for src node
     * @param PropelPDO|null $con  Connection to use.
     *
     ...
     *
     * @param NodeObject     $node Propel object for parent node
     * @param PropelPDO|null $con  Connection to use.
     */
     ...
     *
     * @param NodeObject     $node Propel object of node to create path to
     * @param PropelPDO|null $con  Connection to use.
     *
     ...
     *
     * @param NodeObject|null $node Propel object for src node
     *
     * @return bool
     */
     ...
     *
     * @param NodeObject $child  Propel object for node
     * @param NodeObject $parent Propel object for node
     *
     * @return bool
     */
     ...
     *
     * @param NodeObject $node1 Propel object for node
     * @param NodeObject $node2 Propel object for node
     *
     * @return bool
     */
     ...
     *
     * @param NodeObject     $node Propel object for node
     * @param PropelPDO|null $con  Connection to use.
     *
     * @return bool
     */
